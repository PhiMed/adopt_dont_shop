...
pets.create(name: 'Mr. Pirate', breed: 'tuxedo shorthair', age: 5, adoptable: true)
pets.create(name: 'Clawdia', breed: 'shorthair', age: 3, adoptable: true)
pets.create(name: 'Lucille Bald', breed: 'sphynx', age: 8, adoptable: true)
